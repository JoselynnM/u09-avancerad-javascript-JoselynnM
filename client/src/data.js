...
export const questions = [
	...
	},
	{
		id: 2,
		difficulty: 'Easy',
		question: 'What does an octagonal traffic sign with white letters that says "STOP" mean?        ',
		category: trafficlight,
		correct_answer: 'You must come to a complete stop and yield the right of way to other vehicles',
		incorrect_answers: [
	...
	},
	{
		id: 3,
		difficulty: 'Easy',
		question: 'hat is the primary purpose of a "Baby on Board" sign displayed in a car?',
	...
	},
	{
		...
		difficulty: 'Medium',
		question:
			"What is the main function of an alternator in a car?",
		category: car,
		correct_answer: 'Generate electrical power',
		incorrect_answers: [' Refuel the vehicle', 'Cool the engine', 'Regulate temperature'],
	},
	{
		id: 5,
		difficulty: 'Difficult',
		question:
			'What is the primary purpose of the tire tread on car wheels?',
		category: wheel,
	...
	
	{
		id: 7,
		difficulty: 'Easy',
		question: 'What is the main function of low beam lights (low beams) on a car?',
		category: light,
		correct_answer: 'c) Illuminate the road immediately in front of the vehicle without dazzling other drivers.',
		incorrect_answers: [
	...
	},
	{
		id: 9,
		difficulty: 'Difficult',
		question: 'What type of traffic sign is a red equilateral triangle with a white border?',
		category: trafficlight,
	...
	},
	{
		...
		category: babyonboard,
		correct_answer: 'When they outgrow the weight or height limit of the baby seat',
		incorrect_answers: [
			'At 2 years old', 
	...
	},
	{
		id: 15,
		difficulty: 'Easy',
		question: "What does a circular traffic sign with a diagonal line across a bicycle mean?",
		category: trafficlight,
	...
	},
	{
		...
		difficulty: 'Medium',
		question:
			'What is the function of ABS brakes?',
		category: car,
	...
	},
	{
		...
		category: light,
		correct_answer: 'Illuminate the road at long distances for better visibility',
		incorrect_answers: [
	...
	},
	{
		id: 20,
		difficulty: 'Easy',
		question: 'What does a yellow triangular traffic sign with a symbol of a truck tilting to the right mean?',
		category: trafficlight,
	...
	
	{
		id: 23,
		difficulty: 'Medium',
		question: 'What is one of the main negative environmental impacts of gasoline or diesel-powered cars?',
		category: environment,
	...
	},
	{
		...
		category: car,
		correct_answer: 'You should maintain at least a 2-second following distance to ensure safe stopping.',
		incorrect_answers: [
	...
	},
	{
		...
		difficulty: 'Difficult',
		question:
			'When should high beam lights (high beams) be used in a car?',
		category: light,
		correct_answer: 'When another vehicle is approaching from the opposite direction.',
		incorrect_answers: [
	...
	},
	{
		...
		category: car,
		correct_answer: 'An area around the vehicle that is not visible in the mirrors',
		incorrect_answers: [
	...
	},
	{
		...
		difficulty: 'Medium',
		question:
			'Where should a baby car seat be placed in a car?',
		category: babyonboard,
	...
	},
	{
		id: 30,
		difficulty: 'Easy',
		question: 'What type of vehicle generally produces zero direct emissions from exhaust gases?',
		category: environment,
	...
	
	{
		...
		category: environment,
		correct_answer: 'The total amount of greenhouse gases released by a car over its lifetime',
		incorrect_answers: [
			'Brake wear', 
	...
	},
	{
		id: 40,
		difficulty: 'Easy',
		question: 'What is an effective way to reduce the carbon footprint of a gasoline or diesel-powered car?',
		category: environment,
	...
	},
	{
		...
		category: environment,
		correct_answer: 'The amount of fuel a car consumes to cover a specific distance',
		incorrect_answers: [
	...
	},
	{
		...
		difficulty: 'Difficult',
		question:
			'What is "carpooling," and what is its environmental benefit?',
		category: environment,
		correct_answer: 'Sharing a car with others to reduce traffic congestion and carbon emissions',
		incorrect_answers: [
	...
	},
	{
		...
		difficulty: 'Easy',
		question:
			'What is a "low emission zone" in a city, and what is its goal?',
		category: environment,
		correct_answer: 'A zone where entry of highly polluting vehicles is restricted to improve air quality',
		incorrect_answers: [
	...
	},
	{
		...
		difficulty: 'Medium',
		question:
			'What is meant by "automobile recycling" or "vehicle scrappage"?',
		category: environment,
		correct_answer: 'The reuse of parts from old cars in the manufacturing of new vehicles',
		incorrect_answers: [
	...
	},
	{
		...
		difficulty: 'Easy',
		question:
			'What is the purpose of emission standards for vehicles?',
		category: environment,
		correct_answer: 'To ensure that vehicles emit minimal pollutants into the atmosphere',
		incorrect_answers: [
	...
	},
	{
		id: 47,
		difficulty: 'Medium',
		question: 'How does vehicle maintenance contribute to environmental sustainability?',
		category: environment,
		correct_answer: ' Proper maintenance reduces emissions and prolongs the life of the vehicle',
		incorrect_answers: [
	...
	},
	{
		id: 48,
		difficulty: 'Easy',
		question: 'What is the purpose of a circular traffic sign with a red border and a white number inside it?',
		category: trafficlight,
		correct_answer: 'It indicates the distance in miles or kilometers to a specific destination',
		incorrect_answers: [
	...
	},
	{
		id: 50,
		difficulty: 'Difficult',
		question: 'What is the meaning of a circular traffic sign with a red border and a white symbol of a hand held up in the "stop" position?',
		category: trafficlight,
	...
	},
	{
		id: 51,
		difficulty: 'Easy',
		question: 'What does a rectangular traffic sign with a black arrow pointing downward on a yellow background represent?',
		category: trafficlight,
	...
	},
	{
		id: 56,
		difficulty: 'Easy',
		question: 'What is the function of the low oil pressure warning light on the dashboard?',
		category: light,
	...
	},
	{
		id: 58,
		difficulty: 'Medium',
		question: 'What is the function of the seat belt warning light on the dashboard?',
		category: light,
	...
	},
	{
		id: 59,
		difficulty: 'Difficult',
		question: 'What does the engine temperature warning light on the dashboard indicate?',
		category: light,
	...
	},
	{
		id: 60,
		difficulty: 'Difficult',
		question: 'What does the "ABS" light on the dashboard indicate when it briefly illuminates during startup?',
		category: light,
	...
	},
	{
		id: 61,
		difficulty: 'Medium',
		question: 'What does the "ESP" or "ESC" warning light on the dashboard indicate?',
		category: light,
	...
	},
	{
		id: 62,
		difficulty: 'Easy',
		question: 'When is it appropriate to use a booster cushion instead of a booster seat?',
		category: babyonboard,
		correct_answer: 'When the child can fasten the cars seat belt without assistance',
		incorrect_answers: [
	...
	},
	{
		id: 63,
		difficulty: 'Easy',
		question: 'Why is it important to ensure that seat belts are properly fastened in a child safety seat?',
		category: babyonboard,
		correct_answer: 'To prevent the child from escaping the seat during the trip',
		incorrect_answers: [
	...
	},
	{
		...
		difficulty: 'Medium',
		question:
			'What is the purpose of the LATCH system in a child safety seat?',
		category: babyonboard,
		correct_answer: 'An anchoring and securing system that facilitates the installation of the child seat in the car',
		incorrect_answers: [
	...
	},
	{
		...
		difficulty: 'Medium',
		question:
			'What is the purpose of a baby mirror in the car?',
		category: babyonboard,
		correct_answer: 'To enable parents to see the baby without turning around while driving',
		incorrect_answers: [
	...
	},
	{
		...
		category: babyonboard,
		correct_answer: 'Replace it with a new one, even if it doesnt appear damaged',
		incorrect_answers: [
	...
	},
	{
		...
		category: wheel,
		difficulty: 'Easy',
		question: 'What is the recommended pressure for inflating car tires, typically found in the owners manual or on a sticker inside the drivers door?',
	...
	},
	{
		...
		difficulty: 'Medium',
		question:
			'What is the purpose of the valve stem on a car wheel?',
	...
	},
	{
		...
		category: wheel,
		difficulty: 'Difficult',
		question: 'What is the term for the device that evenly distributes the weight of the vehicle across all four wheels, enhancing stability?',
		correct_answer:
			'Suspension system',
		incorrect_answers: [
			'Tire tread',
	...
	},
	{
		...
		category: wheel,
		difficulty: 'Easy',
		question: 'What does the term "wheel alignment" refer to in car maintenance?',
		correct_answer:
	...
	},
	{
		...
		difficulty: 'Medium',
		question:
			'What is the function of the spare tire in a car?',
		correct_answer:
			'To be used as a replacement for a flat tire',
		incorrect_answers: [
	...
	},
	{
		id: 77,
		difficulty: 'Easy',
		question: 'Why should you regularly inspect your cars tires for signs of wear and damage?',
		category: wheel,
	...
	},
	{
		...
		difficulty: 'Medium',
		question:
			'What does "TPMS" stand for in the context of car tires?',
		category: wheel,
	...
	},
	{
		...
		difficulty: 'Difficult',
		question:
			'Why is it important to maintain proper tire balance?',
		category: wheel,
	...
	},
	{
		id: 80,
		difficulty: 'Difficult',
		question: 'When is it appropriate to use high beam headlights on the highway?',
		category: car,
	...
	},
	{
		...
		correct_answer:
			'They help prevent injuries in case of a collision',
		incorrect_answers: [
