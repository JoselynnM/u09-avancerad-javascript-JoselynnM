...
<>
    ...
    (page3 ? <Final /> : <div className="text-center bg-gray-700 min-h-screen  flex justify-center items-center">
    <Chatbot
      config={config}
    ...
    <div className="flex flex-col items-center justify-center h-screen  bg-[url('/images/roadbg.webp')] text-white">
      ...
      <button className="py-3 px-5 border-separate rounded-2xl bg-white text-black" onClick={handleChange}>Chat with me!</button>
    </div>}
    </>
  );
