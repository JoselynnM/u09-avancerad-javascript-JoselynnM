...
const EditProfile = () => {
  ...
  return (
    ...
    <div className="bg-gray-200 p-8 rounded-lg shadow-lg text-gray-700 max-w-md w-full">
      <h1 className="text-2xl font-bold text-center text-teal-600 mb-6">Edit Your Profile</h1>
      ...
      <div className="mb-4">
        <label htmlFor="profilePicture" className="block text-sm text-gray-500">Upload Profile Picture</label>
        <input
          type="file"
          id="profilePicture"
          accept="image/*"
