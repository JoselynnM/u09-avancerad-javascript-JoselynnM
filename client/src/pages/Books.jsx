      ...
      <div className="grid grid-rows-4 mx-20 grid-flow-col gap-8">
        ...
        <div className="relative flex-1 w-full lg:w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
          <div className="p-6">
            ...
            In this chapter, we will explore the vital connection between traffic lights and your vehicle. Understanding how your Understanding how your vehicle 
            </p>
        ...
        <div className="relative flex-1 w-full  lg:w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
          <div className="p-6">
            ...
            />
            <p className="block font-sans text-base font-light mt-4 leading-relaxed text-inherit antialiased">
            In this chapter, we will address one of the most significant challenges a driver can face: driving in dark conditions while dealing with slippery surfaces due to 
            </p>
          </div>
          <div className="p-6 pt-0">
            <button
        ...
        <div className="relative flex-1 w-full lg:w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
          <div className="p-6">
            ...
            />
            <p className="block font-sans text-base font-light mt-4 leading-relaxed text-inherit antialiased">
            In this chapter, we will explore the harsh reality of traffic accidents and how your vehicle can be involved in them. Road safety is a priority,
            </p>
          </div>
          <div className="p-6 pt-0">
            <button
        ...
        <div className="relative flex-1 w-full lg:w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
          <div className="p-6">
            ...
            City driving is an integral part of the driving experience. Crowded streets, traffic lights, pedestrians, and intersections  
            </p>
          </div>
          <div className="p-6 pt-0">
            <button
...
{isopen4 && (
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
          <div className="bg-white p-5 rounded flex flex-col gap-5 shadow-xl w-96">
            ...
            <div style={{ maxHeight: "400px", overflowY: "auto" }}>
              <strong>Introduction</strong>
              <p>  In this chapter, we will explore the vital connection between traffic lights and your vehicle. Understanding how your vehicle interacts with traffic signals is essential for safe and efficient driving.
              </p>
              <br />
              <video controls className="w-full rounded-lg">
              ...
              <p className="text-gray-700  pt-3 leading-relaxed"/>
                ...
                <br/>
             <p>Traffic lights are a fundamental part of our road infrastructure. They serve several critical functions:</p>                <br />
                <strong>Components of Wheels</strong>
                <br />
                <li><strong>Controlling Traffic: </strong></li>Traffic lights regulate the flow of vehicles, pedestrians, and cyclists at intersections and crossings.
                <li><strong>Enhancing Safety: </strong></li> They reduce the risk of collisions and accidents by providing clear and consistent signals to all road users.
                <li><strong>Managing Congestion:  </strong></li> Traffic lights help manage traffic flow, reduce congestion, and ensure a smooth driving experience.
               <br />
               <br />
               <strong>The Three Standard Traffic Light Colors</strong> <br /> 
               <p>Traffic lights use three primary colors to convey different messages to drivers:</p> <br />             
                <strong>1.  Red Light:</strong>
                <li><i>Meaning:</i> Stop</li>
                <li><i>Action:</i> When the light is red, come to a complete stop behind the stop line or before the crosswalk. You must remain stationary until the light turns green.</li> <br />
                <strong>2. Green Light:</strong>
                <li><i>Meaning:</i> Go</li>
                <li><i>Action:</i> When the light is green, you have the right to proceed through the intersection or along the road. However, always yield to pedestrians and other vehicles that may still be within the intersection.</li><br />
                <strong>3. Yellow Light:</strong>
                <li><i>Meaning:</i> Prepare to Stop</li>
                <li><i>Action:</i> When the light is yellow, it's a signal to prepare to stop. If it is safe to do so, you can proceed through the intersection, but be ready to stop. Do not speed up to make it through a yellow light.</li><br />
                ...
                className="w-full rounded-lg mt-2"
              /> 
                 <h1 className="font-bold mt-3">Special Traffic Light Situations</h1>
                 <p>In addition to the standard red, green, and yellow lights, traffic lights may also include other signals or situations:</p>
                 <li><ins>Flashing Red Light: </ins> </li> Treat a flashing red light like a stop sign. Come to a complete stop and yield the right of way before proceeding. <br />
                 <li><ins>Flashing Yellow Light: </ins></li> A flashing yellow light is a caution signal. Slow down and proceed with caution. <br />
                 <li><ins>Left Turn Arrow:</ins></li> Some intersections have a left turn arrow. This arrow allows left turns while oncoming traffic has a red light. Make the left turn only when the arrow is green. <br />
                 
                 <h1 className="font-bold mt-3">Vehicle Interaction with Traffic Lights</h1>
                 <p>Your vehicle's behavior at traffic lights is crucial for safety and efficiency. Here's how your vehicle should interact with traffic lights:</p> <br />
                 <li>Stopping at Red Lights:</li> Always come to a complete stop at a red light. Do not run the red light, as this poses a significant risk to yourself and others. <br />
                 <li>Proceeding on Green:</li> When the light turns green, proceed with caution, watching for pedestrians and other vehicles. Do not accelerate excessively.<br />
                 <li>Yielding on Yellow: </li>  When the light turns yellow, prepare to stop. If it is safe, you can proceed through the intersection, but do not rush to beat the light. <br />
                 <li>Turning Left on Green:</li>  If you intend to make a left turn on a green light, yield to oncoming traffic and pedestrians. Make the turn when it's safe. <br />
                 
                 <h1 className="font-bold mt-3">Advanced Traffic Situations</h1>
                 <p>Some intersections have advanced traffic signals, such as green arrows for specific turns or dedicated lanes. It's essential to understand these signals and follow them correctly.</p> <br />
                 <p>Traffic lights are a critical aspect of road safety and efficient traffic management. Understanding their meanings and your vehicle's interaction with them is fundamental for responsible and safe driving. Always obey traffic signals and exercise caution at intersections to ensure a smooth and secure driving experience.</p>
            </div>
      ...
      {isopen5 && (
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
          <div className="bg-white p-5 rounded flex flex-col gap-5 shadow-xl w-96">
            ...
            <div style={{ maxHeight: "400px", overflowY: "auto" }}>
              <strong>Introduction</strong>
              <p>  In this chapter, we will explore the harsh reality of traffic accidents and how your vehicle can be involved in them. Road safety is a priority, and understanding how to avoid accidents is essential for all drivers.
              </p>
              <br />
              <img
              ...
              <p className="text-gray-700  pt-3 leading-relaxed"/>
                ...
                <br/>
             <p>Traffic accidents are one of the leading causes of injuries and deaths worldwide. It's important to grasp the magnitude of this issue:</p> <br />
                <li><strong>Millions of Accidents: </strong></li>Every year, millions of traffic accidents occur worldwide.
                <li><strong>Serious Injuries: </strong></li> Many accidents result in serious or permanent injuries to drivers and passengers.
                <li><strong>Loss of Life:  </strong></li> Traffic accidents lead to the loss of hundreds of thousands of lives each year. 
                <br />
                <h1 className="font-bold mt-3">Common Causes of Traffic Accidents</h1>
               <p>Traffic accidents can be caused by a variety of factors, including:</p> <br />             
                <li>Driving Under the Influence: </li> Alcohol and drugs can impair your ability to drive safely.
                <li>Speeding: </li> Driving at an unsafe speed is a common cause of accidents. <br />
                <li>Distracted Driving:</li> Using mobile phones or other distractions while driving can be deadly.
                <li>Disregarding Traffic Signs:</li> Not obeying stop signs, yield signs, and other traffic signals can lead to collisions.<br />
                <li>Weather Conditions:</li> Rain, snow, and fog can make roads hazardous.
              
  
                 <h1 className="font-bold mt-3">The Importance of Vehicle Maintenance</h1>
                 <p>Proper vehicle maintenance is crucial to avoid accidents. You should pay attention to the following:</p>
                 <li ><ins className="font-bold">Brakes:</ins> </li> Well-maintained brakes are critical for stopping your vehicle safely. <br />
                 <li ><ins className="font-bold">Tires:</ins> </li> Worn-out tires can cause your vehicle to lose traction and become difficult to control. <br />
                 <li ><ins className="font-bold">Lights: </ins> </li> Properly functioning headlights and taillights are essential for others to see you. <br />
                 <li ><ins className="font-bold">Suspension: </ins> </li>  A well-maintained suspension helps you maintain control of your vehicle.
                 <h1 className="font-bold mt-3">Avoiding Traffic Accidents</h1>
                 <p>Here are some key ways to avoid traffic accidents:</p> <br />
                 <strong> 1️⃣ Drive Sober:</strong>  Never drive under the influence of alcohol or drugs. <br />
                 <strong> 2️⃣ Maintain a Safe Speed:</strong>Adhere to speed limits and reduce speed in adverse conditions.<br />
                 <strong> 3️⃣ Eliminate Distractions:</strong>  Keep your focus on the road and avoid using your phone while driving. <br />
                 <strong> 4️⃣ Obey Traffic Signs:</strong> Respect all traffic signs and traffic rules. <br />
                 <strong> 5️⃣ Maintain Your Vehicle:</strong> Perform regular maintenance and ensure your vehicle is in good condition. <br />

                 <h1 className="font-bold mt-3">What to Do in Case of an Accident</h1>
                 <p>Despite your best efforts, accidents can happen. It's important to know what to do in case of an accident:</p>
                <strong>Ensure Safety:</strong>  Ensure everyone is safe and off the road. <br />
                <strong>Call the Police:</strong> If necessary, call the police to report the accident. <br />
                <strong>Exchange Information:</strong> Exchange information with other involved drivers, including names, phone numbers, and insurance details. <br />
                <strong>Take Photos:</strong> If it's safe to do so, take photos of the accident scene. <br />
                <strong>Report the Accident:</strong>  Inform your insurance company about the accident and follow their instructions.
                <br />
                <br />
                <p>Road safety is a shared responsibility. Understanding common causes of traffic accidents and taking steps to avoid them is essential for your safety and the safety of others. Proper vehicle maintenance and knowledge of how to respond in case of an accident are crucial steps on your journey to becoming a safe and responsible driver.</p>
            </div>
     ...
     {isopen6 && (
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
          <div className="bg-white p-5 rounded flex flex-col gap-5 shadow-xl w-96">
            <div className="border-b-2 border-gray-300 p-2 mb-2 rounded-tl-lg rounded-tr-lg">
              <h2 className="text-xl font-semibold font-[Poppins]">
              Chapter 7: Driving in Dark and Slippery Conditions in Snow and Rain
              </h2>
            </div>
            ...
            <video controls className="w-full rounded-lg">
              ...
              <strong>Introduction</strong>
              <p className="pt-4">
              In this chapter, we will address one of the most significant challenges a driver can face: driving in dark conditions while dealing with slippery surfaces due to rain or snow. These conditions can be hazardous and require heightened attention and caution. Learning to drive in low-visibility situations and on slippery roads is essential for your safety and that of others.</p>
              <h1 className="font-bold mt-3">Dark Conditions in Snow and Rain</h1>
               <p>The combination of darkness with snow or rain can further complicate driving. Here are some key aspects to consider:</p>
              <p className="text-gray-700  pt-3 leading-relaxed">
                <strong>1. Limited Visibility</strong> 
                <p >Snow and rain significantly reduce visibility, making it 
                ...
                <p>These seats are designed for newborns until they reach a certain 
                  weight or height. They must be installed in a rear-facing position.</p> <br />
                  <strong>3. Increased Braking Distance</strong><br />
                  <p>In wet or snowy conditions, the distance a vehicle needs to come to a stop is much 
                    longer than in dry and clear conditions. This is due to the lack of traction and 
                    the need to overcome the additional resistance of the slippery surface. Reducing 
                    speed is crucial to compensate for this longer braking distance.</p>

                <h1 className="font-bold mt-3">Tips for Driving in the Dark with Rain or Snow</h1>
                 <p>Here are some key tips to stay safe while driving in these challenging conditions:</p><br />
                 <strong> 1️⃣ Vehicle Lights</strong> 
                <p>Use your vehicle lights in their proper setting. In darkness, low beams are essential for good visibility. Ensure your lights are clean and in good working condition.</p> <br />
                <strong> 2️⃣ Windshield Wipers and Defrosters</strong> 
                <p>Ensure your windshield wipers are in good working order and use the defroster if necessary to maintain visibility. Accumulation of snow or rain on the windshield can worsen visibility.</p> <br />
                <strong> 3️⃣ Snow Tires</strong>
                <p>If you live in an area with snowy winters, consider using snow tires. These tires are designed to provide better traction on snow and ice, which can be crucial for maintaining control of your vehicle.</p> <br />
                <strong> 4️⃣ Gentle Braking</strong>
                <p>When you need to brake, do so early and gently to avoid wheel lock on slippery surfaces. Wheel lock can result in loss of control.</p> <br />
                <strong> 5️⃣ Reduce Speed</strong>
                <p>Significantly reduce your speed in snowy or rainy conditions. Driving at a safe speed will give you more reaction time and reduce the likelihood of accidents.</p> <br />
                <strong> 6️⃣ Maintain Following Distance</strong>
                <p>Keep a greater distance between your vehicle and the one in front of you. This will give you more space to stop if needed. In slippery conditions, reaction times can be longer.</p> <br />
                <strong> 7️⃣ Carry an Emergency Kit</strong>
                <p>Carry an emergency kit that includes items like snow chains, a shovel, and blankets in case you get stuck in the snow. These items can be crucial in emergency situations.</p> <br />
              </p>         
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
          <div className="bg-white p-5 rounded flex flex-col gap-5 shadow-xl w-96">
            ...
            <video controls className="w-full rounded-lg">
              ...
              <strong>Introduction</strong>
              <p className="pt-4">
              City driving is an integral part of the driving experience. Crowded streets, traffic lights, pedestrians, and intersections require a special focus and specific driving skills. In this chapter, we will explore key aspects of driving in urban environments so you can safely and efficiently navigate city streets.</p>
              <h1 className="font-bold mt-3">Rules and Regulations</h1>
               <p>When driving in the city, it's important to familiarize yourself with the specific rules and regulations that apply in urban settings. Some important considerations include:</p>
              <p className="text-gray-700  pt-3 leading-relaxed">
                <strong>1. Speed Limits:</strong> 
                <p >Speed limits in urban areas are often lower than on highways. Pay attention to speed limit signs and adjust your speed to traffic conditions.</p> <br />
                <strong>2. Traffic Lights: </strong> 
          <p>Respect traffic lights and traffic signs. Stop at red lights and prepare to proceed when the light turns green.</p> <br />
            <strong>3. Pedestrian Crosswalks: </strong><br />
            <p>Pedestrian crosswalks are areas where pedestrians have the right of way. You must yield to pedestrians crossing the street at these locations.</p>
            <strong>4. Parking: </strong><br />
            <p>Parking in the city can be a challenge. Pay attention to parking regulations, such as parking meters and restricted parking zones.</p>
            <strong>Traffic:</strong>
            <p>City traffic can be intense. Stay calm and maintain a safe following distance. Avoid distractions, such as mobile phone use.</p>


                <h1 className="font-bold mt-3">Intersections</h1>
                <p>Intersections are critical points in city driving. Here are some guidelines for safely navigating them:</p><br />
                <strong> 1️⃣ Signal-Controlled Intersections: </strong> 
                <p>Obey traffic lights. Stop at red lights and proceed on green. Be cautious of vehicles making left turns in front of you.</p> <br />
                <strong> 2️⃣ Unsignalized Intersections:</strong> 
                <p>At intersections without traffic lights, yield the right of way to the vehicle that arrived first or to the one on your right if you arrived simultaneously.</p> <br />
                <strong> 3️⃣ Left Turns:</strong>
                <p>When making a left turn at an intersection, yield to oncoming vehicles.</p> <br />
                <strong> 4️⃣ Pedestrians and Cyclists</strong>
                <p>Yield to pedestrians at pedestrian crossings. Do not overtake them in these areas.</p> <br />
                <strong>Cyclists: </strong>
                <p>Show respect to cyclists and maintain a safe distance when passing them. Some cities have dedicated bike lanes.</p> <br />
               
                <h1 className="font-bold mt-3">Parking</h1>
            <p>Parking in the city can be challenging due to limited space. Here are some recommendations:</p> <br />
            <strong>Parking Meters:</strong>
            <p>When parking in an area with parking meters, make sure to pay and adhere to the allocated time.</p> <br />
            <strong>Restricted Parking Zones: </strong>
            <p>Pay attention to signs indicating restricted parking zones. Parking in these areas may result in fines.</p> <br />
            <strong>Angle Parking:</strong>
            <p>When parking in an angle parking space, ensure you align your vehicle correctly. Do not block traffic or encroach on other spaces.</p> <br />
            <br />
        
            <p>City driving requires attention, patience, and respect for traffic regulations. Keep the safety of pedestrians and cyclists in mind and follow the specific traffic rules for urban areas. With practice and consideration, you can safely and efficiently maneuver through urban environments and enjoy your city driving experience.</p>
                </p>         
            </div>
