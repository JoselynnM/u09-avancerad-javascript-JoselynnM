    ...
    <div className='flex flex-col justify-evenly  items-center shadow-xl rounded-lg w-[600px] m-20 gap- p-9 bg-white'>
      ...
      <table className='w-full mt-5'>
        <thead className='bg-gray-100'>
          <tr>
            <th className='px-6 py-3 text-left text-sm font-medium text-gray-600 uppercase'>Answer</th>
            <th className='px-6 py-3 text-left text-sm font-medium text-gray-600 uppercase'>Correct answer</th>
            <th className='px-6 py-3 text-left text-sm font-medium text-gray-600 uppercase'>Your answer</th>
          </tr>
        </thead>
