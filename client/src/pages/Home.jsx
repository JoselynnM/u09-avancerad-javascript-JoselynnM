      ...
      <section className="mb-12 font-serif">
        ...
        <div className="sm:flex">
          <div className="flex-1 py-6">
            <h2 className="text-[20px]  font-bold sm:text-[55px] leading-none">
              Despacito
            </h2>
          </div>
          <div className="flex-1 pt-9">
            <p className="text-[13px] mb-10 sm:text-[20px]">
              Welcome to the driving course where you can find different courses
              and knowledge that will lead you to be the best behind the wheel.
              {showMoreText && (
                <>
                  Welcome to the driving course where you can find different
                  courses and knowledge that will lead you to be the best behind
                  the wheel.
                </>
              )}
            </p>
